          ...
          <SignIn
            ...
            appearance={{
              ...
              elements: {
                ...
                formFieldInput: 'bg-gray-800 border border-gray-600 rounded-lg px-3 py-2 mt-1 w-full focus:outline-none focus:ring-2 focus:ring-neon-green text-white',
                formButtonPrimary: 'bg-neon-green hover:bg-green-400 text-black py-2 px-4 rounded-lg mt-4 w-full',
