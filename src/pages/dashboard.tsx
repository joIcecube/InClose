  ...
  return (
    <div className="flex flex-col items-center justify-center p-12">
      <motion.div
        ...
        className="w-32 h-32 bg-neon-green rounded-full opacity-20 absolute"
      />
      <motion.div
        animate={{
          scale: [1.2, 1, 1.2],
        ...
        className="w-24 h-24 bg-neon-green rounded-full opacity-30 absolute"
      />
      <motion.div
        animate={{
          scale: [1, 1.1, 1],
      ...
      >
        <Bot className="w-16 h-16 text-neon-green relative z-10" />
      </motion.div>
      <motion.h2
      ...
      <div className="mt-8 w-64 h-3 bg-dark-lighter rounded-full overflow-hidden">
        <motion.div
